  ...
  function Truncate() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getLines", function () {
      var _assertThisInitialize2 = _assertThisInitialized(_this),
          ...
          lineLengthReduction = _assertThisInitialize3.lineLengthReduction,
      ...
      if (textLines.length === 1 && textLines[0].length === 1 && measureWidth(textLines[0]) > targetWidth) {
        ...
        var delimiter = Math.floor(measureWidth(textLines[0]) / targetWidth);
        var maxChars = Math.floor(text.length / delimiter) - lineLengthReduction;
        textLines = [[]];

        for (var l = 0; l < delimiter; l++) {
          var start = Math.floor(l * maxChars);
...
_defineProperty(Truncate, "propTypes", {
  ...
  lineLengthReduction: _propTypes.default.number
});
